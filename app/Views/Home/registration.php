...
<h2 style="margin: 20px;">Upload file</h2>
<div class="form-container">
    <form method="post" action="registration">
        ...
        <div>
            ...
            <div>
                <label>
                    <input type="radio" name="how_did_you_find_me" value="Social media" > Social media
                </label>
                <label>
                    <input type="radio" name="how_did_you_find_me" value="Search engine"> Search engine
                </label>
                <label>
                    <input type="radio" name="how_did_you_find_me" value="Advertisement"> Advertisement
                </label>
                <label>
                    <input type="radio" name="how_did_you_find_me" value="Word of mouth"> Word of mouth
                </label>
                <label>
                    <input type="radio" name="how_did_you_find_me" value="Other" checked> Other
                </label>
            </div>
        </div>

        <div style="margin-top: 10px" class="form-group">
            <button class="btn btn-success" name="register" type="submit" value="submit">Add user</button>
        </div>
    </form>
</div>
